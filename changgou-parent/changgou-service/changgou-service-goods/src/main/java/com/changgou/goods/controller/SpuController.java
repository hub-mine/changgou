...
public class SpuController {
     ...
     */
    @PutMapping("/put/many")
    public Result putMany(@PathVariable(value = "ids") String[] ids) {
    ...
    public Result pullMany(@PathVariable(value = "ids") String[] ids) {
    ...
    public Result updateIsDelete(@PathVariable(value = "id") String id) {
        spuService.updateIsDelete(id);
        return new Result(true, StatusCode.OK, "删除成功");
    }
    ...
    public Result<List<Goods>> findAllGoods() {
        List<Goods> allGoods = spuService.findAllGoods();
        return new Result<>(true,StatusCode.OK,"查询成功",allGoods);
    }
}
