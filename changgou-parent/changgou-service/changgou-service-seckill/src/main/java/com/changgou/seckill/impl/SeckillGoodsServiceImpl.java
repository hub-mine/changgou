...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
     ...
     */
    @Override
    public SeckillGoods findSeckillGoods(String startTime, String id) {
        SeckillGoods seckillGoods = (SeckillGoods)redisTemplate.boundHashOps("SeckillGoods_" + startTime).get(id);
        return seckillGoods;
    }
     ...
     */
    @Override
    public List<SeckillGoods> findByStartTime(String startTime) {
        List<SeckillGoods> list = redisTemplate.boundHashOps("SeckillGoods_" + startTime).values();
        return list;
    }
