...
public class SeckillGoodsController {
     ...
     */
    @GetMapping("/one")
    public Result findOne(String startTime,String id){
        SeckillGoods seckillGoods = seckillGoodsService.findSeckillGoods(startTime, id);
     ...
     */
    @GetMapping("/list")
    public Result findByStartTime(String startTime){
        List<SeckillGoods> list = seckillGoodsService.findByStartTime(startTime);
